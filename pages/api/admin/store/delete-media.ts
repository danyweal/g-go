// pages/api/admin/store/delete-media.ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    if (albumId) {
      const albumRef = adminDb.collection('cms').doc('root').collection('stores').doc(albumId);
    ...
    console.error('POST /api/admin/store/delete-media:', err);
